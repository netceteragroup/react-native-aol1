 ...
 * By changing the value at runtime you can configure different networkIDs for different ADTECH objects (ATBannerView, ATInterstitial, ATMoviePlayerController).
 *
 ...
 * The default value will be loaded from the *ADTECHAdConfiguration.plist* property file upon ATBannerView creation and you can change this value anytime at runtime.
 * By changing the value at runtime you can configure different subNetworkIDs for different ADTECH objects (ATBannerView, ATInterstitial, ATMoviePlayerController).
 *
 * Available in 1.0 and later.
 */
