 ...
 * @since 1.0
 *
 * @param ad The interstitial instance that was hidden.
 *
 ...
 * @since 1.0
 *
 * @param ad The interstitial instance that fetched the ad.
 *
 ...
 * @since 3.5
 *
 * @param ad The interstitial instance that failed getting an ad.
 ...
 */
- (void)didFetchCustomMediation:(ATInterstitial*)ad;
 ...
 */
- (void)didFailFetchingInterstitialAd:(ATInterstitial*)ad;
 ...
 * @see didFailFetchingInterstitialAd:signals:
 */
- (void)didFailFetchingInterstitialAd:(ATInterstitial*)ad signals:(NSArray *)signals error:(NSError *)error;
 ...
 * @since 1.0
 *
 * @param ad The interstitial instance that triggered leaving the application.
 *
 * @warning *Important:* If a request fails the SDK stops fetching ads until you call [ATInterstitial load] again. See the logs in order to know the reason for the error.
 *
 * @see ATInterstitial load
 *
 */
 ...
 *
 *
 * @param ad The interstitial instance that had control of the screen.
